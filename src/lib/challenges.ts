...
export const CHALLENGE_TEMPLATES: ChallengeTemplate[] = [
  ...
  },
  {
    ...
    emoji: '🙏',
    description: 'Chaque jour, écris 1 chose pour laquelle tu es reconnaissant·e dans YATRA · gratitude.',
    duration_days: 7,
    ...
    stake_max_eur: 25,
    reward_target_eur: 5,
    hints: ['Mode YATRA Gratitude', '5 minutes/jour', 'Reflet du rayonnement'],
    category: 'rituel',
  },
  {
    slug: 'meditation-30d',
    ...
    emoji: '🌬️',
    description: '1 session méditation YATRA ≥ 5 min par jour. 25 jours sur 30 = succès.',
    duration_days: 30,
    proof_type: 'self_declared',
    proofs_required: 25,
    stake_min_eur: 15,
    ...
    hints: ['Mode YATRA Méditation guidée', 'Couplé Modes Ambiance binauraux', 'Cohérence cardiaque encouragée'],
    category: 'rituel',
  },
]
